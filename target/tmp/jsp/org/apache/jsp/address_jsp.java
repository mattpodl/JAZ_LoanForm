 ...
 * Generated at: 2018-04-24 21:39:51 UTC
...
return;
    ...
    try {
      ...
      out.write("<label>city: <input type=\"text\" id=\"city\" name=\"city\"/></label>\n");
      out.write("<label>zipCode: <input type=\"text\" id=\"zipCode\" name=\"zipCode\"/></label>\n");
      out.write("<label>street: <input type=\"text\" id=\"street\" name=\"street\"/></label>\n");
      out.write("<label>houseNumber: <input type=\"text\" id=\"houseNumber\" name=\"houseNumber\"/></label>\n");
      out.write("<label>localNumber: <input type=\"text\" id=\"localNumber\" name=\"localNumber\"/></label>\n");
      out.write("<label>phoneNumber: <input type=\"text\" id=\"phoneNumber\" name=\"phoneNumber\"/></label>\n");
      out.write("\n");
